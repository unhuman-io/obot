...
# logitech 922
gst-launch-1.0 v4l2src device="/dev/video1" ! 'video/x-raw,framerate=30/1' ! nvvideoconv ! omxh264enc ! 'video/x-h264, stream-format=(string)byte-stream' ! h264parse ! rtph264pay mtu=1400 ! udpsink host=jetson.local port=5001 sync=false async=false &
# logitech brio
